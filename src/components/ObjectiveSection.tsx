...
export default function ObjectiveSection({ style }: { style: SectionStyle }) {
 ...
 return (
  ...
  >
   <div className="max-w-4xl mx-auto w-full bg-black/40 backdrop-blur-md p-6 sm:p-8 md:p-12 rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/10 shadow-2xl">
    ...
    {isLoadingObjective ? (
     <div className="animate-pulse space-y-6">
      <div className="space-y-3">
       <div className="h-8 md:h-12 bg-white/10 rounded w-full" />
       <div className="h-8 md:h-12 bg-white/10 rounded w-2/3" />
      </div>
