 ...
 return (
  <main className="min-h-screen bg-[#050505] px-6 pb-24 pt-32 text-white sm:px-8 lg:px-10">
   <section className="mx-auto max-w-5xl">
    ...
    <div className="mt-14 border-l border-white/15">
     {experiences.map((experience) => (
      <article key={experience.company} className="relative pb-12 pl-8 last:pb-0">
       ...
       <div className="border border-white/10 bg-white/[0.04] p-7">
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
         <div>
          ...
          <p className="mt-2 text-white/60">{experience.role}</p>
         </div>
